...
# let's see how the data looks on the table
...
model1 = Net(2, 1, 1)
# Train the model
model_training(model1)

# create a model with two neuron
model2 = Net(2, 2, 1)
# Train the model
model_training(model2)

# create the model with three neurons
model3 = Net(2, 3, 1)
# Train the model
model_training(model3)

## we can found that the more neurons we set, the more accurate the model is